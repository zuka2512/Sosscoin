...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sosscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sosscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sosscoin transaction") + "\n" +
              "  sosscoin-tx [options] -create [commands]   " + _("Create hex-encoded sosscoin transaction") + "\n" +
              "\n";
