...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sosscoin-project/sosscoin>";
    const std::string URL_WEBSITE = "<https://sosscoin.org>";
