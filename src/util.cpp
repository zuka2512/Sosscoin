...
const char * const BITCOIN_CONF_FILENAME = "sosscoin.conf";
const char * const BITCOIN_PID_FILENAME = "sosscoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sosscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sosscoin";
#else
    // Unix
    return pathRet / ".sosscoin";
#endif
#endif
}
